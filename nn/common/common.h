...
#define MAVLINK_COMMON_XML_HASH 753373501946897806
...
{
   MAV_CMD_TARGET_SUICIDE_WP=15, /*  Mav_cmd_taget Suicide_wp is suicide plane target | Latitude| Longitude| | | Latitude| Longitude| Altitude|  */
